...
def LEVEL4function(topic_chosen):
    #--- TOPIC BOTH
    myfile = 'QUESTION_GENERATION/katakanaPLACES_VERYHARD.csv'
    ...
    while wannagoon == 'y':
        ...
        #hint = chosen_df.loc[randomnumber]['hint'] NO HINT
        ...
        if listsimilaritiesSORTED[0] != similarityratioCORRECT:
            ...
            print(distractor2, 'would bes ', katakana2, ' (automatically transcribed)')
